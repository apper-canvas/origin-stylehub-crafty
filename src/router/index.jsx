    ...
    children: [
      ...
      // Main application routes
      {
        ...
        children: [
          ...
          createRoute({ path: "shop", element: <Shop /> }),
          createRoute({ path: "product/:id", element: <ProductDetail /> }),
          createRoute({ path: "cart", element: <Cart /> }),
          createRoute({ path: "wishlist", element: <Wishlist /> }),
          createRoute({ path: "checkout", element: <Checkout /> }),
          createRoute({ path: "order-confirmation/:orderId", element: <OrderConfirmation /> }),
          createRoute({ path: "reviews", element: <Reviews /> }),
          createRoute({ path: "orders", element: <OrderHistory /> }),
          createRoute({ path: "orders/tracking/:orderId", element: <OrderTracking /> }),
